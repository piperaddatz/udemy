...
class SubtopicsControllerTest < ActionController::TestCase
  ...
  test "should create subtopic" do
    assert_difference('Subtopic.count') do
      post :create, subtopic: { is_demo: @subtopic.is_demo, name: @subtopic.name, sort: @subtopic.sort, topic_id: @subtopic.topic_id }
    end
  ...
  test "should update subtopic" do
    patch :update, id: @subtopic, subtopic: { is_demo: @subtopic.is_demo, name: @subtopic.name, sort: @subtopic.sort, topic_id: @subtopic.topic_id }
    assert_redirected_to subtopic_path(assigns(:subtopic))
  end
